...
def make_string(card):
    ...
    if card_number == "Ace":
        card_number = "a"
    elif card_number == "Two":
        card_number = "2"
    elif card_number == "Three":
        card_number = "3"
    elif card_number == "Four":
        card_number = "4"
    elif card_number == "Five":
        card_number = "5"
    elif card_number == "Six":
        card_number = "6"
    elif card_number == "Seven":
        card_number = "7"
    elif card_number == "Eight":
        card_number = "8"
    elif card_number == "Nine":
        card_number = "9"
    elif card_number == "Ten":
        card_number = "10"
    elif card_number == "Jack":
        card_number = "j"
    ...
    if card_name == "Spades":
        card_name = "s"
    elif card_name == "Diamonds":
        card_name = "d"
    elif card_name == "Clubs":
        card_name = "c"
    elif card_name == "Hearts":
        card_name = "h"
...
def recognize_cards(frame, card_analyzer):
    saved_cards_array = card_analyzer.board
    __frame = imread(frame)
    cards = detect_cards(__frame)
    if saved_cards_array == []:
        firts= False
        i = 0
        for card in reversed(cards):
            saved_cards_array.append([])
            for j in range(0,i):
                saved_cards_array[i].append('[]')
            saved_cards_array[i].append(make_string(card))
            i += 1
    else:
        for card in cards:
            all_cards = []
            card_str = make_string(card)
            
            for blocks in saved_cards_array:
                for card in blocks:
                    all_cards.append(card)
                    
            if card_str not in all_cards:
                saved_cards_array = card_str
    return saved_cards_array
